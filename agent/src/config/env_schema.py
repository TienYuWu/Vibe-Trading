...
class DataConfig(_EnvBase):
    ...
    market_data_order_tw_equity: str = Field(alias="MARKET_DATA_ORDER_TW_EQUITY", default="")
    market_data_order_tw_futures: str = Field(alias="MARKET_DATA_ORDER_TW_FUTURES", default="")
